...
print ('This program aims to determine if any three numbers can be Pythagorean triples or not')

print ('Input 3 positive real numbers >0 to check if they can be Pythagorean triples or not')
